...
<head>
  ...
  <title>Belvedere App</title>
  
  <!-- Librerie React -->
  <script crossorigin src="https://unpkg.com/react@18/umd/react.development.js"></script>
  <script crossorigin src="https://unpkg.com/react-dom@18/umd/react-dom.development.js"></script>
  
  <!-- Babel per far funzionare JSX nel browser -->
  <script src="https://unpkg.com/@babel/standalone/babel.min.js"></script>
  
  <!-- Libreria Supabase -->
  <script src="https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2"></script>
  
  <!-- Libreria React-Draggable -->
...
<body>
  ...
  <script type="text/babel">
    ...
    const supabaseUrl = 'INSERISCI_IL_TUO_SUPABASE_URL';
    const supabaseKey = 'INSERISCI_LA_TUA_SUPABASE_KEY';
    ...
    function App() {
      ...
      const analizzaComandoRigido = async (frase) => {
        ...
        if (matchPersone && matchTavolo && matchOra) {
          ...
          alert(`🤔 Non ho capito il comando.\nHai detto: "${frase}".\nUsa un formato come: "Aggiungi 5 persone alle ore 20 e 30 al tavolo 26"`);
        }
      };
